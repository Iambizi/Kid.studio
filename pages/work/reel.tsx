...
export default function reels({ reelData }: Type):JSX.Element{
    ...
    const allEntriesOfaSpace = `https://cdn.contentful.com/spaces/environments/master/entries/${reelEntryID}?access_token=${process.env.NEXT_PUBLIC_CONTENTFUL_ACCESSKEY}&include=10`;
