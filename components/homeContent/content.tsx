    ...
    return(
        <>
            <section className={styles.noScroll}>
                ...
                <p className={styles.nextButton} onClick={goNext} onTouchStart={goNext}>NEXT</p>
                <p className={styles.previousButton} onClick={goPrevious} onTouchStart={goNext}>PREVIOUS</p>
