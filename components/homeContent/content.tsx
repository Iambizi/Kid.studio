    ...
    return(
        <>
            <section className={styles.noScroll}>
                ...
                <p className={styles.nextButton} id={"next"} onTouchStart={goNext} onClick={goNext}>NEXT</p>
                <p className={styles.previousButton} id={"previous"} onTouchStart={goPrevious} onClick={goPrevious}>PREVIOUS</p>
